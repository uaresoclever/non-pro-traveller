...
const TrailPicker = () => {
  ...
  const getRecommendedTrails = () => {
    ...
    if (answers.time === 'short') {
      ...
      recommendedTrailNos = ['1', '2', '4', '7'] // Trail 1: 45-60min, Trail 2: 2hrs, Trail 4: 1.5-2hrs, Trail 7: 1.5hrs
    } else if (answers.time === 'medium') {
      console.log("✅ Time is medium (>2 hours, half day)")
      recommendedTrailNos = ['3', '5'] // Trail 3: 2.5-3hrs, Trail 5: 3hrs (both >2 hours)
